  ...
  try {
    ...
    if (message.content === '!reglas') {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          "**🇪🇸 Español**\n" +
          "Los Términos y Condiciones describen tus responsabilidades y derechos como parte de la comunidad Host. Al participar, aceptas seguir estas reglas para mantener un ambiente seguro y respetuoso para todos los miembros.\n\n" +
          "**🇺🇸 English**\n" +
